...
const
  _ = require('lodash'),
  TimeTrackerService = require('./services/TimeTrackerService'),
  ComputedFieldsService = require('./services/ComputedFieldsService'),
...
class KuzzlePlugin {
  ...
  init (customConfig, context) {
    ...
    this.timeTrackerService = new TimeTrackerService(this.context, this.config);
    this.computedFieldsService = new ComputedFieldsService(this.context, this.config);
    ...
    this.pipes = {
      ...
      'document:beforeCreate': (...args) => this.computedFieldsService.calculateComputedFields(...args),
      'document:beforeCreateOrReplace': (...args) => this.computedFieldsService.calculateComputedFields(...args),
      'document:beforeReplace': (...args) => this.computedFieldsService.calculateComputedFields(...args),
      'document:beforeReplace': (...args) => this.computedFieldsService.calculateComputedFields(...args)
    };
    ...
    this.computedFields = [];
    this.sourceFields = {};
     this.computedFieldsService.initStorage(this.storage )
      .then(()=> this.computedFieldsService.loadComputedFields());
  }
